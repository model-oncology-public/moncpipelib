...
def _register_builtin_patterns() -> None:
    ...
    register_pattern(BlobMirrorPattern())
    register_pattern(BrowserExportPattern())


_register_builtin_patterns()

BUILTIN_PATTERN_NAMES: frozenset[str] = frozenset(INGEST_PATTERNS)
"""Names registered by :func:`_register_builtin_patterns`, snapshotted at
import before any consumer registration can widen the registry."""
